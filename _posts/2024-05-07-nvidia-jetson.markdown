...
Download [Bootloader(QSPI) Package][driver-pkg-bsp] from this [location][jetpack6-website] (select `IGX-SW 1.1.1 Production Release`). Extract `Jetson_Linux_R36.4.5_aarch64.tbz2`.
